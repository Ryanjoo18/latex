...
\input{3_Dynamics}
\input{4_Forces}
\input{5_WorkEnergyPower}
\input{6_CircularMotion}
\input{7_GravitationalField}

\part{Thermal Physics}
\input{8_TemperatureAndIdealGases}
\input{9_FirstLawOfThermodynamics}

\part{Oscillation and Waves}
\input{10_Oscillations}
\input{11_WaveMotion}
\input{12_Superposition}

\part{Electricity and Magnetism}
\input{13_ElectricFields}
\input{14_CurrentOfElectricity}
\input{15_DC.Circuits}
\input{16_Electromagnetism}
\input{17_ElectromagneticInduction}
\input{18_AlternatingCurrent}

\part{Modern Physics}
\input{19_QuantumPhysics}
\input{20_NuclearPhysics}
